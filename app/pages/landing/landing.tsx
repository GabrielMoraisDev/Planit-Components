...
const { menuOpen } = useDataContext();
  return(
    ...
    <section className={`border-t border-slate-300 w-full h-16 md:h-20 fixed top-16 right-0 bg-white z-50 shadow-sm ${menuOpen?'md:w-[70%] lg:w-[80%] 2xl:w-[85%] w-[100%]':'w-[100%]'} ml-auto duration-300`}>
