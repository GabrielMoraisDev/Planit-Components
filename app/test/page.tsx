...
const Carousel3D = () => {
  ...
  const items = [
    ...
    { title: 'Imagem 5', description: 'Descrição da imagem 2', imageUrl: 'https://img.freepik.com/vetores-gratis/fundo-de-paisagem-de-verao-para-zoom_52683-42162.jpg?t=st=1739411112~exp=1739414712~hmac=ab98c321de7cc4e633095f87b49eb7886f6e2f3e0aa1677070c9e4b0034c6036&w=1380' },
  ];
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto h-96 overflow-hidden perspective mt-52 bg-white p-5">
      <div className="absolute left-0 h-full w-44 bg-gradient-to-l z-10"></div>
      <div className="absolute right-0 h-full w-44 bg-gradient-to-r z-10"></div>
      <div className="relative w-full h-full">
        ...
        >
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                <div className='bg-white relative w-[30rem] h-full mx-auto overflow-hidden rounded-lg transform-style-preserve-3d flex justify-center duration-1000'>
                  <img src={item.imageUrl} alt={item.title} className={`${index === currentItem ? 'opacity-100' : 'opacity-40'} duration-1000 w-[30rem] h-full`} style={{ objectPosition: 'center' }} />
        ...
        <button
          onClick={() => {rotate(1); setCurrentItem(currentItem === 0 ? 4 : currentItem - 1)}}
        ...
        <button
          onClick={() => {rotate(-1); setCurrentItem(currentItem === 4 ? 0 : currentItem + 1)}}
