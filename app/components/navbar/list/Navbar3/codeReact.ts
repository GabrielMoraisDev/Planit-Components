export const codeStringReact = `import { useState, useEffect } from 'react';
    ...
    return (
        ...
        &lt;Icon.Search size={22} className={\`cursor-pointer lg:hidden text-slate-700 dark:text-white dark:hover:text-slate-200 absolute right-5 $\{menu ? ' animate-duration-200' : ''}\`}onClick={() =&gt; {setMenu(false);setSearch(prevSearch =&gt; !prevSearch);}}/&gt;
            ...
            &lt;div className="flex justify-center items-center absolute transform top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 right-5 lg:-translate-y-1/2 lg:-translate-x-0 lg:left-0 lg:right-auto lg:w-full"&gt;
                &lt;a href='/' className={\`lg:absolute lg:left-3 }\`}&gt;&lt;img src='/planit.png' className='w-10 h-10' alt='Logo' width={300} height={300}/&gt;&lt;/a&gt;

                &lt;div className="hidden lg:flex items-center lg:ml-[-16rem] lg:text-[1.3vw] xl:text-[0.9vw] 2xl:text-[0.8vw]"&gt;
                    &lt;a href='/' className={\`text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-400 mx-4 xl:mx-6 2xl:mx-[1.48vw] duration-300 \`}&gt;Home&lt;/a&gt;
                    &lt;a href='/' className={\`text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-400 mx-4 xl:mx-6 2xl:mx-[1.48vw] duration-300 \`}&gt;Products&lt;/a&gt;
                    &lt;a href='/' className={\`text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-400 mx-4 xl:mx-6 2xl:mx-[1.48vw] duration-300 \`}&gt;Features&lt;/a&gt;
                    &lt;a href='/' className={\`text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-400 mx-4 xl:mx-6 2xl:mx-[1.48vw] duration-300 \`}&gt;Heroes&lt;/a&gt;
                    &lt;div onMouseEnter={()=&gt;setList(true)} onMouseLeave={()=&gt;setList(false)} className={\`mx-2 xl:mx-3 2xl:mx-[1.48vw] cursor-pointer text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-200 duration-300 relative \`}&gt;
                        ...
                        &lt;div className={\`$\{list?'max-h-96 pt-3 p-2':'max-h-0 pt-0 p-0'} rounded-md md:w-[12vw] xl:w-[11vw] 2xl:w-45 bg-slate-100 dark:bg-slate-800  duration-300 absolute ml-[-4rem] text-center mt-0 overflow-hidden z-30\`}&gt;
                            &lt;div className='h-10 flex justify-center place-items-center'&gt;
                                &lt;a href='/' className={\`text-slate-700 dark:text-white dark:hover:text-slate-200 hover:text-slate-500 duration-300\`}&gt;Item 1&lt;/a&gt;&lt;br /&gt;
                            &lt;/div&gt;
                        ...
                        &lt;/div&gt;
                    &lt;/div&gt;
                    &lt;a href='/' className={\`text-slate-900 hover:text-slate-400 dark:text-white dark:hover:text-slate-200' mx-2 xl:mx-3 2xl:mx-[1.48vw] duration-300 \`}&gt;About&lt;/a&gt;
                    ...
                    &lt;div className="absolute right-5 flex justify-center place-items-center"&gt;
                        ...
                        &lt;a href="#" target='_blank'  rel='noopener noreferrer' className={\`2xl:w-5 lg:w-4 mx-2 2xl:mx-3 flex justify-center place-items-center cursor-pointer \`}&gt;&lt;Icon.aedin size={20} className={\`text-slate-700 dark:text-white dark:hover:text-slate-400 hover:text-slate-400 duration-300 xl:text-sm 2xl:text-md text-md\`}/&gt;&lt;/a&gt;
            ...
            &lt;div className={\`absolute top-14 z-50 text-slate-700 dark:text-white dark:hover:text-slate-400 w-full $\{menu ? 'max-h-[35rem]' : 'max-h-0'} bg-white dark:bg-slate-600 text-base duration-500 mt-[-0.1rem] overflow-hidden lg:hidden\`}&gt;
                ...
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Home&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Products&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Features&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Heroes&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Item 1&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;Item 2&lt;/p&gt;&lt;/a&gt;
                &lt;hr className='mx-8 opacity-25' /&gt;
                &lt;a href='/' className={\`hover:text-slate-700 dark:text-white dark:hover:text-slate-400\`}&gt;&lt;p className='text-center my-[0.83rem] duration-300'&gt;About&lt;/p&gt;&lt;/a&gt;
