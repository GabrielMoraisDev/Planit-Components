...
export default function Nav1() {
  return (
    <div className="h-auto w-56 rounded-lg relative cursor-pointer overflow-hidden hover:scale-105 duration-300">
        ...
        <div className="w-full h-auto min-h-32 light:bg-white dark:bg-slate-800 p-3 pb-9">
            <h1 className="text-xl font-bold dark:text-white">Title of post</h1>
            ...
            <p className='text-sm my-2 dark:text-white'>Ver mais</p>
            <hr className='dark:border-slate-400'/>
        </div>
        <div className="absolute bottom-0 w-full h-auto text-left px-3 pb-2 dark:text-slate-400 text-sm flex place-items-center"><Icon.Award className='mr-1'/>01/01/2025</div>
    </div>
  )
}