...
export default function Nav2() {
  ...
  <div className="w-full h-16 md:h-20 relative top-0 left-0 bg-white dark:bg-slate-900 z-50 shadow-sm">
    ...
    <div id="menu" className={`w-full ${menu?'max-h-96 shadow-sm':'max-h-0'} mt-0 bg-white dark:bg-slate-900 duration-300 overflow-hidden lg:hidden`}>
      <ul className="flex flex-col justify-center items-center h-full mt-5">
        <a href="#"><li className="w-full h-16 flex justify-center place-items-center text-slate-700 dark:text-slate-200 hover:text-sky-600 duration-300">Home</li><hr className="w-[80vw]"/></a>
        <a href="#"><li className="w-full h-16 flex justify-center place-items-center text-slate-700 dark:text-slate-200 hover:text-sky-600 duration-300">Products</li><hr className="w-[80vw]"/></a>
        <a href="#"><li className="w-full h-16 flex justify-center place-items-center text-slate-700 dark:text-slate-200 hover:text-sky-600 duration-300">Certifications</li><hr className="w-[80vw]"/></a>
        <a href="#"><li className="w-full h-16 flex justify-center place-items-center text-slate-700 dark:text-slate-200 hover:text-sky-600 duration-300">Customers</li><hr className="w-[80vw]"/></a>
        <a href="#"><li className="w-full h-16 flex justify-center place-items-center text-slate-700 dark:text-slate-200 hover:text-sky-600 duration-300">About</li></a>
      </ul>
    </div>
  </div>
  )
