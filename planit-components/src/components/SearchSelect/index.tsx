  ...
  return (
    ...
    >
      ...
      <div className={clsx("flex justify-start place-items-center h-10")}>
        ...
        <div
          className={clsx(
            "absolute left-0 w-full h-full z-10 border-slate-300 border",
        ...
        <p className={clsx(
          internalValue !== "" ? "text-slate-800 dark:text-white" : "text-slate-400",
          "truncate mt-1",
          spaces[0],
            ...
            <div className={clsx(
              ...
              <input
                ...
                className={clsx(
                  ...
                  colors[1] !== '' ? colors[1] : 'dark:text-slate-300',
          ...
          {filteredOptions.length > 0 ? (
            filteredOptions.map((opt, index) => (
              <div key={index}>
                ...
                <div
                  className={clsx(
                    !sizes[2] ? 'w-full min-h-11' : sizes[2],
                    !spaces[2] ? 'px-4' : spaces[2],
                    "flex place-items-center cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-500 dark:text-slate-300"
                  )}
            ...
            <div className={clsx("w-full min-h-11 flex place-items-center justify-center text-slate-400")}>
              {notFoundPlaceholder}
            </div>
          )}
        </div>
