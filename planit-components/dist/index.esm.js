...
var SearchSelect = function (_a) {
    ...
    var _j = useState(options), filteredOptions = _j[0], setFilteredOptions = _j[1];
    ...
    return (jsxs("div", { ref: containerRef, className: baseStyles.container, children: [jsx("input", { type: "hidden", name: name, value: value }), jsxs("div", { className: baseStyles.trigger, onClick: handleToggle, role: "combobox", "aria-expanded": isOpen, "aria-haspopup": "listbox", children: [jsx("span", { className: selectedOption ? 'text-gray-900' : 'text-gray-500', children: selectedOption ? selectedOption.label : placeholder }), jsx("svg", { className: baseStyles.arrow, width: "20", height: "20", viewBox: "0 0 20 20", fill: "currentColor", children: jsx("path", { fillRule: "evenodd", d: "M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z", clipRule: "evenodd" }) })] }), jsxs("div", { className: baseStyles.dropdown, children: [jsx("input", { ref: searchInputRef, type: "text", className: baseStyles.searchInput, placeholder: searchPlaceholder, value: searchTerm, onChange: function (e) { return setSearchTerm(e.target.value); }, onClick: function (e) { return e.stopPropagation(); } }), jsx("div", { className: baseStyles.optionsList, role: "listbox", children: filteredOptions.length > 0 ? (filteredOptions.map(function (option) { return (jsx("div", { className: "".concat(baseStyles.option, " ").concat(option.value === value ? baseStyles.selectedOption : ''), onClick: function () { return handleOptionSelect(option.value); }, role: "option", "aria-selected": option.value === value, children: option.label }, option.value)); })) : (jsx("div", { className: baseStyles.noResults, children: "Nenhuma op\u00E7\u00E3o encontrada" })) })] })] }));
};
